...
<form>
	...
	<h4 style="color:black; font-size:320%; text-align:center; border:2px;">EDIT CLINIC</h4>

<div>
	<form:form action="${pageContext.request.contextPath}/clinics/save" method="post" commandName="clinicForm">
	<td>ID:</td>
