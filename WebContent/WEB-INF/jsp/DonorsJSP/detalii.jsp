...
<table>
	...
	<tr>
		...
		<td><c:out value="${donor.cnp }"/></td>
		<td><c:out value="${donor.adresa }"/></td>
		<td><c:out value="${donor.email }"/></td>
		<td><c:out value="${donor.numarTelefon }"/></td>
	</tr>
</table>
<br>
<input class="MyButton" type="button" value="Back" onclick="window.location.href=' <c:url value="/donors.htm"/>'"/>
</body>
</html>