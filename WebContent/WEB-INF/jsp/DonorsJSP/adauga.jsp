...
<h4 style="color:black; font-size:320%; text-align:center; border:2px;">ADD DONOR</h4>

<div>
	<form:form action="${pageContext.request.contextPath}/donors/adaugaSave" method="post" commandName="donorForm">
	<td>Nume:</td>
